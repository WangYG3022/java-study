...
public class StreamDemoTest {
    ...
    private List<Person> people = Arrays.asList(
            new Person("张三", 18, 1000, Person.Status.FREE),
            new Person("李四", 23, 2000, Person.Status.BUSY),
            new Person("王五", 26, 3454, Person.Status.VOCATION),
            new Person("赵六", 31, 8888, Person.Status.BUSY),
            new Person("田七", 22, 9999, Person.Status.FREE)
    );
